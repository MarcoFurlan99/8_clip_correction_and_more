...
It is to be noted that these parameters are relatively much easier than previous experiments ($\min\limits_{\mu_1, \mu_2} (\mu_2 - \mu_1) = 24$, $\max\limits_{\sigma \in \lbrace \sigma_1, \sigma_2 \rbrace} \sigma = 30$).
